...
const start = (kill = new Client()) => {
    console.log(color('\n> DEV OFICIAL ='), color(' gustavo > https://wa.me/+56935382355', 'yellow'))
	console.log(color('\n> GRUPO OFICIAL ='), color(' https://chat.whatsapp.com/CTr959xpSTTISWGy2HAdqh', 'yellow'))
	console.log(color('\n>'), color('[gustavo] Inicializacion finalizada, YA PUEDES USAR COMADOS...\n', 'red'))
